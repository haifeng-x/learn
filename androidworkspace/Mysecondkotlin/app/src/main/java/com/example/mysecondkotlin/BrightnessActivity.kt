    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        Bright_atuodown.setOnClickListener(object : View.OnClickListener {
            override fun onClick(v: View?) {
                ...
                Toast.makeText(v?.context, "brihtdownclick", Toast.LENGTH_LONG).show();

                while (windowBrightness > 0.1) {
                    windowBrightness = windowBrightness - 0.1F
                ...
                if (windowBrightness > 0.0 && windowBrightness < 0.1)
                    windowBrightness = 0F
